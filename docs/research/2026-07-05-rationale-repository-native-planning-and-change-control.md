...
ADR 0005 が Negative として挙げていたリスク（ローカルファイルと GitHub メタデータのドリフト、ステータス更新が人間の規律に依存しすぎること）は、開発の第2段階での採用アダプター側レビューにおいて「親 issue の陳腐化」という形で現実のものとなった（用語は [README](README.md)）。その実践上の観測は、LISS-0005 という新たな issue へと還流し、プロセス改善のトリガーとなった。
