...
この文章自体は、運用テンプレートに新しいゲートを追加するものではない。ここで述べた哲学が具体的な規則へ進む必要があるなら、ADR や collaboration 文書へ別途昇格する（[規範と読み物](2026-07-06-rationale-normative-vs-reading-documents.md)）。その一線を守ることも、Referee-centered collaboration の重要な一部である。
